...
import { Layers, Zap, Shield, Boxes, ArrowRight, CheckCircle } from "lucide-react";
...
export function CompanyTechnologySection() {
  ...
  const techFeatures = {
    scalability: {
      ...
      description: "Our modular architecture allows us to dynamically build and adapt AI pipelines for any data source or workflow. This approach reduces deployment time by over 50% and improves performance by up to 40%.",
      benefits: [
    ...
    flexibility: {
      ...
      description: "With over 400 million theoretical pipeline combinations, our Auto-Optimization Engine finds the perfect configuration for your specific needs, ensuring you always have the best-performing, most up-to-date technology.",
      benefits: [
    ...
    security: {
      ...
      description: "From dedicated VPC environments to our Zero-Trust model, we provide enterprise-grade security that meets stringent biopharma compliance standards like GxP and HIPAA.",
      benefits: [
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-20">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-5xl mx-auto tracking-body leading-relaxed font-condensed">
            Generic AI solutions fail in the complex, regulated world of biopharma. We built our 
            <span className="text-gray-900 font-semibold"> PhnyX Modular RAG architecture</span> from the ground up 
            to solve the industry's core challenges: fragmented data and inefficient workflows.
          </p>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-6 text-lg text-gray-600 font-condensed tracking-body leading-relaxed">
                  <p>
                    Unlike monolithic AI systems, our modular approach treats each component as 
                    an interchangeable "Lego block" that can be dynamically combined and optimized.
                  </p>
                  <p>
                    This revolutionary design delivers unparalleled <span className="text-gray-900 font-semibold">Scalability</span>, 
                    <span className="text-gray-900 font-semibold"> Flexibility</span>, and 
                    <span className="text-gray-900 font-semibold"> Security</span> - the three pillars that make 
                    PhnyX Lab fundamentally different by design.
                  </p>
                </div>
                
                <div className="grid grid-cols-3 gap-6 mt-12">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900 mb-1">400M+</div>
                    <div className="text-xs text-gray-500 font-condensed">Pipeline Combinations</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900 mb-1">50%</div>
                    <div className="text-xs text-gray-500 font-condensed">Faster Deployment</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900 mb-1">100%</div>
                    <div className="text-xs text-gray-500 font-condensed">Compliant & Secure</div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="aspect-square bg-white rounded-xl border border-gray-200 p-8 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-gray-900 font-medium mb-2">Modular RAG Architecture</div>
                  ...
                  <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                          <h4 className="text-2xl font-bold text-gray-900 tracking-subtitle">{feature.title}</h4>
                      ...
                      <div className="space-y-3">
                        {feature.benefits.map((benefit, index) => (
                          <div key={index} className="flex items-center gap-3">
                            ...
                            <span className="text-gray-600 font-condensed tracking-body">{benefit}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="relative">
                      <div className="aspect-square bg-white rounded-xl border border-gray-200 flex items-center justify-center p-8">
                        <div className="text-center">
                          ...
                          <div className="text-gray-600 text-sm font-condensed">{feature.subtitle}</div>
                        </div>
                      </div>
                    </div>
                  </div>
