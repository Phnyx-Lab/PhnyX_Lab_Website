      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-12 tracking-hero leading-hero">
            <span className="inline-block mr-4 md:mr-6">Ready</span>
            <span className="inline-block mr-4 md:mr-6">to</span>
            <br />
            <span className="inline-block mr-4 md:mr-6">Redefine Your</span>
            <br />
