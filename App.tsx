...
import { getOrganizationStructuredData, getCheironStructuredData } from "./components/StructuredData";
import { initializePerformanceMonitoring, PerformanceMonitor } from "./utils/performance";
    ...
    switch (currentPage) {
      case "products":
        return {
          ...
          description: "Advanced biopharma AI platform featuring Cheiron Finder and Write - revolutionary pharmaceutical AI tools for intelligent literature review, regulatory document automation, and clinical research. Enterprise-grade AI for drug discovery.",
          keywords: "Cheiron AI, biopharma AI platform, pharmaceutical AI tools, drug discovery software, clinical AI platform, pharma automation tools, AI medical writing, regulatory AI automation, pharmaceutical research AI, biotech AI solutions, clinical document AI, pharma workflow AI, drug development platform, biopharma technology, pharmaceutical innovation tools",
      ...
      case "company":
        return {
          ...
          description: "Leading biopharma AI company revolutionizing pharmaceutical research. PhnyX Lab's journey from SK Networks AI initiative to independent biotech AI pioneer, transforming drug discovery with cutting-edge artificial intelligence solutions.",
          keywords: "PhnyX Lab, biopharma AI company, pharmaceutical AI startup, biotech AI solutions, drug discovery AI company, pharma technology company, AI medical research, pharmaceutical innovation company, biotech startup, clinical AI company, pharma AI platform, medical AI solutions, biopharma technology, pharmaceutical artificial intelligence",
      ...
      case "request-demo":
        return {
          ...
          description: "Get in touch with PhnyX Lab to discover how Cheiron AI can revolutionize your biopharma workflows. Schedule a personalized demo of our pharmaceutical AI platform and transform your drug discovery process.",
          keywords: "biopharma AI demo, pharmaceutical AI consultation, Cheiron AI demo, drug discovery AI demo, pharma automation demo, biotech AI consultation, clinical AI platform demo, pharmaceutical workflow demo, AI medical writing demo, regulatory AI demo, pharma technology consultation",
          canonicalUrl: "https://phnyx.ai/contact"
        };
      case "thank-you":
        return {
          title: "Thank You - PhnyX Lab",
          description: "Thank you for your interest in PhnyX Lab. Our team will contact you within 24 hours to discuss how Cheiron can help your organization.",
          canonicalUrl: "https://phnyx.ai/thank-you"
        };
      default:
        return {
          title: "PhnyX Lab - AI Toolkit for Modern Biopharma",
          description: "Leading biopharma AI platform transforming pharmaceutical workflows with intelligent document automation, AI-powered literature review, and regulatory writing tools. Reduce drug discovery research time by 80% with Cheiron AI.",
          keywords: "biopharma AI, pharmaceutical AI, drug discovery AI, clinical research automation, AI medical writing, pharma workflow automation, biotech AI solutions, regulatory AI tools, pharmaceutical software, clinical AI platform, medical AI assistant, pharma document automation, drug development AI, biopharma technology, pharmaceutical innovation",
